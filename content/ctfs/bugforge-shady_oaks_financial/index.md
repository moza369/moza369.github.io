---
title: "BugForge – Shady Oaks Financial"
description: "An easy-level web vulnerability challenge focused on JWT privilege escalation. It demonstrates how improper signature validation and insecure client-side token management allow users to manipulate roles and IDs to bypass access controls, reach the admin panel, and retrieve the flag."
date: 2026-01-09
categories: [CTF]
tags: [ctf, web, bugforge, jwt]
image: /images/challenges/bugforge/shadyoaks-financial/cover-bugforge_shadyoaks_financial.jpeg
...
- **Challenge Name:** Shady Oaks Financial
- **Platform:** bugforge
- **Category:** Web
- **Difficulty:** Easy
- **Points:** 10
...
![Login Page](/images/challenges/bugforge/shadyoaks-financial/loginpage.png)

![Register Page](/images/challenges/bugforge/shadyoaks-financial/register.png)
...
![Dashboard Page](/images/challenges/bugforge/shadyoaks-financial/dashboard.png)

![Token Page](/images/challenges/bugforge/shadyoaks-financial/token-cookie.png)
...
![EditJwt Page](/images/challenges/bugforge/shadyoaks-financial/editjwt.png)
